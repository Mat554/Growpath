...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/admin/dashboard.js', 'resources/js/admin/questions.js', 'resources/js/admin/publisher.js', 'resources/js/mobile/admin/dashboard.js'])
