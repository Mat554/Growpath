...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/js/app.js', 'resources/js/parent/dashboard.js', 'resources/js/parent/dashboard-report.js', 'resources/js/mobile/parent/dashboard.js'])
...
<body class="bg-[#F4F7F6] font-sans flex h-screen overflow-hidden text-[#333]">
    ...
    <main class="flex-1 p-4 md:p-8 pb-24 md:pb-8 overflow-y-auto">
        ...
        {{-- Header --}}
        <div class="dashboard-header flex flex-col md:flex-row justify-between items-start md:items-center mb-8 md:mb-10 gap-4">
            <div>
            ...
            <div class="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                ...
                <div class="relative z-50" id="notificationDropdown">
                    ...
                    <div id="notificationMenu" class="hidden absolute left-0 md:left-auto md:right-0 mt-3 w-[calc(100vw-2rem)] max-w-[360px] bg-white rounded-2xl shadow-[0_15px_40px_rgba(0,0,0,0.12)] border border-gray-100 z-50 overflow-hidden transform opacity-0 scale-95 transition-all duration-200 origin-top-left md:origin-top-right">
                ...
                <div class="bg-white px-5 py-2.5 rounded-full shadow-sm border border-gray-100 flex items-center gap-2.5 text-sm font-semibold text-[#4A90E2] truncate">
        ...
        <div class="w-full flex justify-center">
                ...
                <div id="report-content" class="bg-white w-full max-w-[900px] rounded-[20px] shadow-[0_10px_40px_rgba(0,0,0,0.08)] overflow-hidden report-card mb-10 relative">
                    ...
                    <div class="p-6 md:p-10">
                        ...
                        <div class="animate-fade-in" style="animation-delay: 0.2s;">
                            <div class="bg-[#EBF5FF] border-l-[6px] border-[#4A90E2] p-6 mb-8 shadow-sm flex flex-col md:flex-row gap-6 items-center -mx-6 md:-mx-10 px-6 md:px-10">                                
                        ...
                        <div class="mt-10 animate-fade-in" style="animation-delay: 0.5s;">
                            ...
                            <div class="w-full h-[250px] md:h-[320px] relative bg-white p-2 md:p-4 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div id="action-buttons" class="mt-10 pt-6 border-t border-gray-100 flex flex-col md:flex-row gap-4 justify-center no-print animate-fade-in" style="animation-delay: 0.8s;">
                            <button onclick="downloadPDF()" class="w-full md:w-auto px-8 py-3.5 bg-[#4A90E2] hover:bg-[#357ABD] text-white rounded-xl font-semibold shadow-lg shadow-[#4A90E2]/30 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-2 border-none cursor-pointer">
            ...
            @else
                <div class="bg-white w-full max-w-[900px] p-6 md:p-10 rounded-[20px] shadow-sm border border-gray-100 text-center flex flex-col items-center justify-center min-h-[400px]">
    ...
    {{-- Mobile Nav (LENGKAP DENGAN TOMBOL LOGOUT) --}}
                ...
                if (canvas) {
                    ...
                    new Chart(ctx, {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Poin',
                                data: [mockResult.scores.R, mockResult.scores.I, mockResult.scores.A, mockResult.scores.S, mockResult.scores.E, mockResult.scores.C],
                                borderColor: '#4A90E2',
