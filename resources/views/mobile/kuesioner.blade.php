        ...
        <div class="p-4 md:p-8 pb-0 md:pb-0 shrink-0">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                ...
                <div class="w-full md:w-auto relative">
                    <input type="text" id="searchInput" onkeyup="searchKuesioner()" placeholder="Cari test..." class="w-full md:w-64 pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#4A90E2] focus:ring-4 focus:ring-[#4A90E2]/10 transition-all font-sans">
            ...
            <div class="flex gap-2 border-b border-gray-200 pb-px overflow-x-auto hide-scrollbar" id="filterTabs">
                <button onclick="filterKuesioner('semua', this)" class="tab-btn active px-5 py-2.5 text-sm font-semibold text-[#4A90E2] border-b-2 border-[#4A90E2] whitespace-nowrap transition-all cursor-pointer bg-transparent font-sans">Semua Test</button>
