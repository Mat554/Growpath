...
<body class="bg-[#F4F7F6] font-sans flex h-screen overflow-hidden">
    ...
    <main class="flex-1 p-4 md:p-8 overflow-y-auto">
     ...
     src="{{ Auth::user()->avatar ? 'https://ivmjjoplrdblxwhjzpcb.storage.supabase.co/storage/v1/s3' . Auth::user()->avatar : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name).'&background=4A90E2&color=fff&size=128' }}" 
