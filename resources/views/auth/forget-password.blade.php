...
<body class="bg-[#f3f4f6] min-h-screen flex justify-center items-center p-5 font-sans">
    ...
    <div class="bg-white w-full max-w-[500px] rounded-[24px] shadow-[0_20px_40px_-5px_rgba(0,0,0,0.1)] p-10 flex flex-col justify-center relative overflow-hidden">
        ...
        <div class="mb-8 text-center">
            ...
            <h2 class="text-2xl font-bold text-[#1f2937] mb-2 tracking-tight">Lupa Password?</h2>
            <p class="text-[#6b7280] text-sm leading-relaxed">
                Jangan khawatir. Masukkan alamat email yang terdaftar, dan kami akan mengirimkan kode OTP untuk mereset password Anda.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('password.email') }}" id="resetForm">
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <i class="ph ph-envelope-simple absolute left-4 top-1/2 -translate-y-1/2 text-[#9ca3af] text-xl peer-focus:text-[#4A90E2] transition-colors"></i>
                </div>
            </div>
        ...
        <div class="text-center mt-6 text-[0.9rem]">
            <a href="{{ route('login') }}" class="text-[#6b7280] font-medium hover:text-[#4A90E2] flex items-center justify-center gap-2 transition">
