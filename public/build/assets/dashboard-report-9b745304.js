document.addEventListener("DOMContentLoaded",()=>{typeof window.reportData<"u"&&y()});function y(){setTimeout(()=>{const a=document.getElementById("loading");a&&(a.style.display="none");const t=window.reportData;if(!t)return;const d=new Date(t.created_at),m=document.getElementById("testDate");m&&(m.innerText=d.toLocaleDateString("id-ID",{day:"numeric",month:"long",year:"numeric"}));const r=document.getElementById("domCode");r&&(r.innerText=t.dominant_code);const e=15;l("barR","scoreR",t.scores.R,e),l("barI","scoreI",t.scores.I,e),l("barA","scoreA",t.scores.A,e),l("barS","scoreS",t.scores.S,e),l("barE","scoreE",t.scores.E,e),l("barC","scoreC",t.scores.C,e);const n=document.getElementById("riasecChart");if(n&&typeof Chart<"u"){const s=n.getContext("2d"),i=s.createLinearGradient(0,0,0,300);i.addColorStop(0,"rgba(74, 144, 226, 0.5)"),i.addColorStop(1,"rgba(74, 144, 226, 0.0)"),new Chart(s,{type:"line",data:{labels:["Realistic","Investigative","Artistic","Social","Enterprising","Conventional"],datasets:[{label:"Poin",data:[t.scores.R,t.scores.I,t.scores.A,t.scores.S,t.scores.E,t.scores.C],borderColor:"#4A90E2",backgroundColor:i,borderWidth:3,pointBackgroundColor:"#ffffff",pointBorderColor:"#4A90E2",pointBorderWidth:2,pointRadius:5,pointHoverRadius:7,fill:!0,tension:.4}]},options:{animation:{onComplete:()=>{window._chartReady=!0}},responsive:!0,maintainAspectRatio:!1,plugins:{legend:{display:!1}},scales:{y:{beginAtZero:!0,max:10,grid:{color:"#f3f4f6",borderDash:[5,5]},border:{display:!1}},x:{grid:{display:!1},border:{display:!1},ticks:{font:{family:"'Poppins', sans-serif",weight:"500"},color:"#6b7280"}}}}})}},500)}function l(a,t,d,m){let r=d/m*100;r>100&&(r=100);const e=document.getElementById(a),n=document.getElementById(t);n&&(n.innerText=`${d} Poin`),e&&setTimeout(()=>{e.style.width=r+"%"},100)}window.downloadPDF=async function(){const a=document.getElementById("pdf-overlay"),t=document.getElementById("pdf-overlay-title"),d=document.getElementById("pdf-overlay-subtitle"),m=document.getElementById("pdf-progress-bar"),r=window.reportData;function e(o,c,g){m.style.width=o+"%",c&&(t.textContent=c),g&&(d.textContent=g)}a.classList.add("active"),e(0,"Menyiapkan laporan...","Mengambil data hasil tes"),await new Promise(o=>setTimeout(o,300)),e(15,"Memproses grafik...","Mengkonversi chart ke gambar"),window._chartReady||await new Promise(o=>setTimeout(o,1e3));const n=document.getElementById("riasecChart");let s="";n&&n.width>0&&(s=n.toDataURL("image/png",1)),await new Promise(o=>setTimeout(o,200)),e(30,"Menyusun halaman...","Membangun layout dokumen");const i=document.getElementById("action-buttons");i&&(i.style.display="none");const u=document.getElementById("report-content").innerHTML;i&&(i.style.display="flex"),await new Promise(o=>setTimeout(o,200)),e(50,"Membuat dokumen...","Memuat font dan aset");const p=document.createElement("iframe");p.style.cssText="position:fixed;top:0;left:0;width:750px;height:100vh;opacity:0;pointer-events:none;border:none;z-index:-1;",p.setAttribute("data-pdf-frame","true"),document.body.appendChild(p);const f=p.contentDocument||p.contentWindow.document;f.open(),f.write(`<!DOCTYPE html>
<html lang="id">
<head>
<meta charset="UTF-8">
...
window.addEventListener('load', async function() {
    ...
    const opt = {
        ...
        filename: 'Laporan_RIASEC_${r.dominant_code}.pdf',
...
</html>`),f.close(),e(70,"Merender konten...","Sedang memproses halaman"),await new Promise(o=>{window.addEventListener("message",function c(g){g.data==="pdf-done"&&(window.removeEventListener("message",c),o())})}),e(100,"Selesai!","PDF berhasil diunduh ✓"),await new Promise(o=>setTimeout(o,900));const b=document.querySelector("iframe[data-pdf-frame]");b&&b.remove(),a.classList.remove("active")};
